...
export const BlogMajor = () => {
  return (
    <div className="relative h-44 items-end flex overflow-hidden rounded-md group hover:scale-105 duration-100 cursor-pointer group-hover:shadow-sm group-hover:shadow-black">
      <Image
